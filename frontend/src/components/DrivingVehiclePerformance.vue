    ...
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                ...
                color="primary"
                text
                @click="openModifyPerformance"
            >
                ModifyPerformance
            </v-btn>
            <v-dialog v-model="modifyPerformanceDiagram" width="500">
                <ModifyPerformanceCommand
                    @closeDialog="closeModifyPerformance"
...
<script>
    ...
    export default {
        name: 'DrivingVehiclePerformance',
        components:{
        },
        props: {
        ...
        data: () => ({
            ...
            modifyPerformanceDiagram: false,
        }),
	async created() {
        },
        methods: {
            ...
            openModifyPerformance() {
                this.modifyPerformanceDiagram = true;
            },
            closeModifyPerformance() {
                this.modifyPerformanceDiagram = false;
            },
        },
    }
</script>
