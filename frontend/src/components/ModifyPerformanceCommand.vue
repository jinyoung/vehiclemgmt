<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <int offline label="AccumulatedDistanceBefore" v-model="value.accumulatedDistanceBefore" :editMode="editMode" @change="change"/>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.value.accumulatedDistanceBefore = {};
        ...
        methods: {
            modifyPerformance() {
                this.$emit('modifyPerformance', this.value);
            },
            close() {
