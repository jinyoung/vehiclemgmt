        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <DrivingVehiclePerformance :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: 
                [
                    { text: "registrationId", value: "registrationId" },
                    ...
                    { text: "accumulatedDistanceBefore", value: "accumulatedDistanceBefore" },
